...
//   $('.kline').attr('data-type',KlineIns.isSized)
//   if (KlineIns.isSized) {
...
//     let height = $('.kline').height();
//     let width = $('.kline').width();
//     $("#kline_container").css({visibility: 'visible',width:width+'px', height: height + 'px'});
//     on_size(width, height);
//   }
// }

$('body').off().on('click', '#sizeIcon', function () {
    KlineIns.isSized = !KlineIns.isSized;
    $('.kline').attr('data-type',KlineIns.isSized)
    if (KlineIns.isSized) {
        $(KlineIns.element).css({
...
var template_str = "\n" +
    ...
    "                    <div id=\"sizeIcon\" onclick=\"\" class=\"chart_BoxSize\"></div>\n" +
    "                </div>\n" +
    "            </div>\n" +
    "            <!-- ToolPanel -->\n" +
...
var Hammer = require("kline/lib/hammer.min")
...
$(() => {
  ...
  $(document).on('click',function () {
    setTimeout(function () {
      if(location.pathname=='/index/about'){
        hammertime = new Hammer(document.querySelector('#kline_container'), hammerOpt);
...
/*  if(location.pathname=='/index/about'){
    ...
    // 移动端拖动开始
    $("body").on('touchstart', '#chart_overlayCanvas', function (e) {
        KlineIns.buttonDown = true;
        var _touch = e.originalEvent.targetTouches[0];
        var r = e.target.getBoundingClientRect();
        var x = _touch.pageX - r.left;
        var y = _touch.pageY - r.top;
        ChartManager.getInstance().onMouseDown("frame0", x, y);
    });

    $("body").on('touchend', '#chart_overlayCanvas', function (e) {
        KlineIns.buttonDown = false;
    ...
    $("body").on('touchmove', '#chart_overlayCanvas', function (e) {
